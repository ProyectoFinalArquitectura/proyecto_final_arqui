    ...
    <main className="min-h-screen px-6 py-10 text-white">
      <div className="glass-bar mx-auto max-w-3xl rounded-3xl p-8 transition-all duration-300">
        ...
        <p className="mt-3 text-white/70">
          Login exitoso. Esta vista confirma que la redireccion por rol ORGANIZADOR esta funcionando.
        </p>
        <button
          className="focus-outline mt-8 rounded-2xl bg-[var(--color-primary)] px-5 py-3 text-sm font-bold text-black"
